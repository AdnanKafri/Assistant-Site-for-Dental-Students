...
<div class="container">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" required class="form-control" name="Address" id="exampleInputAddress" value="{{ old('Address') }}">
        </div>
        <div class="form-group">
            <label for="exampleInputBdate">Age</label>
            <input type="number" required class="form-control" name="age" id="exampleInputBdate" value="{{ old('age') }}">
        </div>
        <div class="form-group">
